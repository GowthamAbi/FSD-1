...
import { 
  FaChartPie, FaFileExport, FaMoneyBillWave, 
  FaClipboardList, FaBullseye, FaWallet 
} from "react-icons/fa";
...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    checkLoginState(); // Ensure state is correct on mount

    window.addEventListener("storage", checkLoginState); // Listen for changes
    return () => {
  ...
  return (
    <div className="w-64 h-screen bg-gray-900 text-white p-4 fixed left-0 top-16"> 
